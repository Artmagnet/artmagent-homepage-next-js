...
const ClientPage = ({ source }:IClientPage) => {
  ...
  return (<div className={ style.container}>
    <MDXRemote {...source}
      components={{
        h1: (props) => <h1 className="text-3xl underline-offset-8 font-bold flex flex-col gap-3" {...props} />,
        ...
        th: (props: any) => (
          <th className="border border-gray-300 bg-gray-200 px-4 py-2 text-left" {...props} />
        ),
        td: (props: any) => (
